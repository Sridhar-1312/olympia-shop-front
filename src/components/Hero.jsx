...
const Hero = () => {
  return (
    <div className="relative min-h-screen flex items-center justify-center pt-48">
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
            Experience premium shopping with our curated collection of exclusive
            products. Quality, style, and elegance delivered right to your
            doorstep.
          </p>
